...
export default function FutureSection() {
  ...
  return (
    <section
      id="future"
      className="py-24 bg-gradient-to-b from-black to-[#1A1A1A] relative"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            As AI technology continues to advance, the capabilities of Qlab AI
            will expand, opening up new possibilities for filmmakers.
          </p>
        </ScrollAnimation>
        ...
        <ScrollAnimation animation="fadeUp" delay={0.3} className="mt-20">
          <ReflectiveSurface className="max-w-4xl mx-auto rounded-xl p-8 md:p-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-6 text-center">
              Join the AI Filmmaking Revolution
            </h3>
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto text-center">
              Be among the first filmmakers to harness the power of AI in your
              creative process. Request access to FilmAI and transform your
              filmmaking workflow.
            </p>
            <form
              id="access-form"
            ...
            >
              ...
              <p className="text-gray-400 text-sm text-center">
                By requesting access, you agree to our Terms of Service and
                Privacy Policy.
              </p>
            </form>
          </ReflectiveSurface>
