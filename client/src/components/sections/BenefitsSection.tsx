    ...
    <section id="benefits" className="py-24 bg-black relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollAnimation animation="fadeUp" className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">The Future of Filmmaking</h2>
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            FilmAI doesn't just enhance your current process—it revolutionizes what's possible in filmmaking.
          </p>
        </ScrollAnimation>
        
        <div className="grid md:grid-cols-2 gap-x-16 gap-y-24">
          {benefits.map((benefit, index) => (
            <ScrollAnimation key={benefit.id} animation="fadeUp" delay={index * 0.1}>
