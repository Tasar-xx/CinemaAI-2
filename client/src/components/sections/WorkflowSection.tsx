    ...
    <section id="workflow" className="py-24 bg-[#1A1A1A] relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollAnimation animation="fadeUp" className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">Seamless Filmmaking Workflow</h2>
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            From initial concept to final production, FilmAI integrates with your existing workflow to enhance every step of the creative process.
          </p>
        </ScrollAnimation>
          ...
          <div className="space-y-24">
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <ScrollAnimation animation="slideLeft" className="md:text-right">
                  <h3 className="text-2xl font-bold text-white mb-4">Pre-Production</h3>
                  <p className="text-gray-300 mb-4">Develop scripts, visualize concepts, scout locations virtually, and plan every visual detail before production begins.</p>
                  ...
                  <ReflectiveSurface className="rounded-xl overflow-hidden">
                    <AspectRatio ratio={16/9} className="bg-[#2C2C2E]">
                      <div className="flex items-center justify-center">
                        <p className="text-sm text-gray-500">Pre-production workflow visualization</p>
                      </div>
                    </AspectRatio>
                  </ReflectiveSurface>
                </ScrollAnimation>
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <ScrollAnimation animation="slideRight" className="md:order-2">
                  ...
                  <p className="text-gray-300 mb-4">On-set tools for visualizing camera setups, testing lighting configurations, and making real-time creative decisions.</p>
                  <ul className="space-y-2">
                    <li className="text-gray-400">Camera lensing and framing tests</li>
                    <li className="text-gray-400">Real-time lighting simulations</li>
                    <li className="text-gray-400">On-set blocking visualization</li>
                    <li className="text-gray-400">Performance capture and review</li>
                  </ul>
                </ScrollAnimation>
                <ScrollAnimation animation="slideLeft" className="md:order-1">
                  <ReflectiveSurface className="rounded-xl overflow-hidden">
                    <AspectRatio ratio={16/9} className="bg-[#2C2C2E]">
                      <div className="flex items-center justify-center">
                        <p className="text-sm text-gray-500">Production assistance visualization</p>
                      </div>
                    </AspectRatio>
                  </ReflectiveSurface>
                </ScrollAnimation>
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <ScrollAnimation animation="slideLeft" className="md:text-right">
                  ...
                  <p className="text-gray-300 mb-4">Transform your footage with advanced post-production tools, from relighting scenes to voice modulation and VFX integration.</p>
                  <ul className="space-y-2 md:ml-auto md:text-right">
                    <li className="text-gray-400 flex md:justify-end">
                ...
                <ScrollAnimation animation="slideRight">
                  <ReflectiveSurface className="rounded-xl overflow-hidden">
                    <AspectRatio ratio={16/9} className="bg-[#2C2C2E]">
                      <div className="flex items-center justify-center">
                        <p className="text-sm text-gray-500">Post-production tools visualization</p>
                      </div>
                    </AspectRatio>
                  </ReflectiveSurface>
                </ScrollAnimation>
