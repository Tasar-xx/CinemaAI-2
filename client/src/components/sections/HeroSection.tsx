...
import femaleGroupImage from "@assets/4.png";
    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-b from-black to-[#1A1A1A] py-20 mt-16">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: `url(${femaleGroupImage})` }}
        ></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            The ultimate visual prototyping platform that transforms every stage
            of your filmmaking process with powerful AI tools.
          </motion.p>
